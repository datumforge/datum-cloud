...
import (
	...
	"github.com/datumforge/datum-cloud/config"
	"github.com/datumforge/datum-cloud/jsonschema/envparse"
)
...
func generateSchema(c schemaConfig, structure interface{}) error {
	...
	for _, pkg := range includedPackages {
		if err := r.AddGoComments("github.com/datumforge/datum-cloud/", pkg); err != nil {
			panic(err.Error())
		}
	}
